...
from sympy import hermite, symbols, simplify
...
def hermite_polynomial(n):
    ...
    if n == 0:
        ...
        return simplify(2*x*hermite_polynomial(n-1) - 2*(n-1)*hermite_polynomial(n-2))
...
# Berechnet den Erwartungswert  <x*x> im Zustand der n Wellenfunktion. Das uneigentliche Integral kann durch 
